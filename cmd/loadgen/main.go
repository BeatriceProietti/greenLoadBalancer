...
func main() {
	...
	// Pre-generated difficulty sequence (one per request, in the order
	// in which jobs are created) from a seeded RNG: the same -n and -seed
	// always produce the same sequence, regardless of the load balancing
	// policy currently being tested.
